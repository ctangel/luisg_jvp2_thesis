class Comms:
    ...
    """
        ...
        of self.data_only
    """
    def switchData_Only(self):
        data_only = not data_only
        return data_only
    """
    ...
    """
        Will return the 64-bit serial number of the local Xbee device as a hex string.
    """
    def getLocalAddr(self):
        #TODO:
        #    1) query serial number high
        #    2) query serial number low
        #    3) Turn into a hex string
        #    4) Add them together and return
