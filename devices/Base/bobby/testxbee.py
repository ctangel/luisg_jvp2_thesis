...
def send_ping():
    ...
    #h = sp.check_output("./encrypt '%s' %s  < param/a3.param" % (json.dumps(m), "gogogadject"), shell=True)
    broadcast_enc_pub('\x00\x13\xa2\x00'+'Au\xbc\x91', json.dumps(m), "gogoadject")
    #broadcast_enc_pub(None, h)
